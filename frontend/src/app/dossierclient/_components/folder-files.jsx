                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      <div>
                        ...
                        <p className="text-foreground">{fiche.nom_atelier}</p>
                      </div>
                      <div>
                        <p className="text-muted-foreground">Client:</p>
                        <p className="text-foreground">{fiche.nom_client}</p>
                      </div>
                      <div>
                    ...
                    <div className="mt-2 text-xs text-muted-foreground flex justify-between">
                      <span>
                        Créé: {new Date(fiche.created_at).toLocaleDateString()}
                      </span>
                      <span>
                        MAJ: {new Date(fiche.updated_at).toLocaleDateString()}
                      </span>
                    </div>
                  </div>
                ))
